...
public class ProductForm extends JFrame {
    ...
    public ProductForm(List<Product> products, Mavenproject3 parent) {
        ...
        leftPanel.setBorder(BorderFactory.createTitledBorder("Form Penjualan"));
        ...
        leftPanel.add(new JLabel("Barang:"), gbc);
        gbc.gridx = 1;
        ...
        leftPanel.add(new JLabel("Stock tersedia:"), gbc);
        gbc.gridx = 1;
        ...
        tableModel = new DefaultTableModel(new String[]{"Barang", "Stock Tersedia", "Harga", "Quantity"}, 0);
    ...
    private void loadProductData() {
        ...
        for (Product p : products) {
            tableModel.addRow(new Object[]{p.getName(), p.getStock(), p.getPrice(), p.getQuantity()});
        }
    }
